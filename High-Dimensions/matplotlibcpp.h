//
// Created by Zachary Halpern on 2019-04-02.
//

#ifndef HIGH_DIMENSIONS_MATPLOTLIBCPP_H
#define HIGH_DIMENSIONS_MATPLOTLIBCPP_H
...
private:
    ...
    _interpreter()
    {
        ...
        if (!s_python_function_show || !s_python_function_close || !s_python_function_draw ||
            ...
            !s_python_function_semilogy || !s_python_function_loglog || !s_python_function_fill ||
            ...
            !s_python_function_xlabel || !s_python_function_ylabel || !s_python_function_grid ||
            !s_python_function_xlim || !s_python_function_ion || !s_python_function_ginput || !s_python_function_save ||
            !s_python_function_clf || !s_python_function_annotate || !s_python_function_errorbar ||
            !s_python_function_errorbar || !s_python_function_tight_layout || !s_python_function_stem ||
            !s_python_function_xkcd || !s_python_function_text || !s_python_function_suptitle ||
        ...
        if (!PyFunction_Check(s_python_function_show) || !PyFunction_Check(s_python_function_close) ||
            ...
            !PyFunction_Check(s_python_function_figure) || !PyFunction_Check(s_python_function_fignum_exists) ||
            !PyFunction_Check(s_python_function_plot) || !PyFunction_Check(s_python_function_quiver) ||
            !PyFunction_Check(s_python_function_semilogx) || !PyFunction_Check(s_python_function_semilogy) ||
            ...
            !PyFunction_Check(s_python_function_ginput) || !PyFunction_Check(s_python_function_save) ||
            !PyFunction_Check(s_python_function_clf) || !PyFunction_Check(s_python_function_tight_layout) ||
...
#endif // HIGH_DIMENSIONS_MATPLOTLIBCPP_H
